...
export interface AddressBookInterfaceInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getLiquidationManager', values?: undefined): string
  encodeFunctionData(functionFragment: 'getMarginCalculator', values?: undefined): string
  encodeFunctionData(functionFragment: 'getMarginPool', values?: undefined): string
  encodeFunctionData(functionFragment: 'getOracle', values?: undefined): string
  encodeFunctionData(functionFragment: 'getOtokenFactory', values?: undefined): string
  encodeFunctionData(functionFragment: 'getOtokenImpl', values?: undefined): string
  ...
  encodeFunctionData(functionFragment: 'setLiquidationManager', values: [string]): string
  encodeFunctionData(functionFragment: 'setMarginCalculator', values: [string]): string
  encodeFunctionData(functionFragment: 'setMarginPool', values: [string]): string
  encodeFunctionData(functionFragment: 'setOracleImpl', values: [string]): string
  encodeFunctionData(functionFragment: 'setOtokenFactory', values: [string]): string
  encodeFunctionData(functionFragment: 'setOtokenImpl', values: [string]): string
  ...
  decodeFunctionResult(functionFragment: 'getLiquidationManager', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getMarginCalculator', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getMarginPool', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getOracle', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getOtokenFactory', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getOtokenImpl', data: BytesLike): Result
  ...
  decodeFunctionResult(functionFragment: 'setLiquidationManager', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setMarginCalculator', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setMarginPool', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setOracleImpl', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setOtokenFactory', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setOtokenImpl', data: BytesLike): Result
...
export interface AddressBookInterface extends BaseContract {
  ...
  callStatic: {
    ...
    setAddress(_id: BytesLike, _newImpl: string, overrides?: CallOverrides): Promise<void>

    setController(_controller: string, overrides?: CallOverrides): Promise<void>

    setLiquidationManager(_liquidationManager: string, overrides?: CallOverrides): Promise<void>

    setMarginCalculator(_calculator: string, overrides?: CallOverrides): Promise<void>

    setMarginPool(_marginPool: string, overrides?: CallOverrides): Promise<void>

    setOracleImpl(_otokenImpl: string, overrides?: CallOverrides): Promise<void>

    setOtokenFactory(_factory: string, overrides?: CallOverrides): Promise<void>

    setOtokenImpl(_otokenImpl: string, overrides?: CallOverrides): Promise<void>
  ...
  populateTransaction: {
    getAddress(_id: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>

    getController(overrides?: CallOverrides): Promise<PopulatedTransaction>

    getLiquidationManager(overrides?: CallOverrides): Promise<PopulatedTransaction>

    getMarginCalculator(overrides?: CallOverrides): Promise<PopulatedTransaction>
