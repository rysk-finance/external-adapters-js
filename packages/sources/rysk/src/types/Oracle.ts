...
export interface OracleInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getDisputer', values?: undefined): string
  encodeFunctionData(functionFragment: 'getExpiryPrice', values: [string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'getPrice', values: [string]): string
  encodeFunctionData(functionFragment: 'getPricer', values: [string]): string
  encodeFunctionData(functionFragment: 'getPricerDisputePeriod', values: [string]): string
  encodeFunctionData(functionFragment: 'getPricerLockingPeriod', values: [string]): string
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'setAssetPricer', values: [string, string]): string
  encodeFunctionData(functionFragment: 'setDisputePeriod', values: [string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'setDisputer', values: [string]): string
  encodeFunctionData(
    functionFragment: 'setExpiryPrice',
    values: [string, BigNumberish, BigNumberish],
  ): string
  encodeFunctionData(functionFragment: 'setLockingPeriod', values: [string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'setStablePrice', values: [string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'transferOwnership', values: [string]): string

  decodeFunctionResult(functionFragment: 'disputeExpiryPrice', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'endMigration', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getChainlinkRoundData', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getDisputer', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getExpiryPrice', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getPrice', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getPricer', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getPricerDisputePeriod', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getPricerLockingPeriod', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'isDisputePeriodOver', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'isLockingPeriodOver', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'migrateOracle', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'owner', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'renounceOwnership', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setAssetPricer', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setDisputePeriod', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setDisputer', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setExpiryPrice', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setLockingPeriod', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'setStablePrice', data: BytesLike): Result
...
export type DisputerUpdatedEvent = TypedEvent<[string], { newDisputer: string }>
...
export type PricerUpdatedEvent = TypedEvent<[string, string], { asset: string; pricer: string }>
...
export interface Oracle extends BaseContract {
  ...
  functions: {
    ...
    getPricerDisputePeriod(_pricer: string, overrides?: CallOverrides): Promise<[BigNumber]>

    getPricerLockingPeriod(_pricer: string, overrides?: CallOverrides): Promise<[BigNumber]>
  ...
  callStatic: {
    ...
    setAssetPricer(_asset: string, _pricer: string, overrides?: CallOverrides): Promise<void>
    ...
    setStablePrice(_asset: string, _price: BigNumberish, overrides?: CallOverrides): Promise<void>

    transferOwnership(newOwner: string, overrides?: CallOverrides): Promise<void>
  }

  filters: {
    'DisputerUpdated(address)'(newDisputer?: string | null): DisputerUpdatedEventFilter
    ...
    PricerUpdated(asset?: string | null, pricer?: string | null): PricerUpdatedEventFilter

    'StablePriceUpdated(address,uint256)'(
      asset?: string | null,
      price?: null,
    ): StablePriceUpdatedEventFilter
    StablePriceUpdated(asset?: string | null, price?: null): StablePriceUpdatedEventFilter
  }
  ...
  estimateGas: {
    ...
    endMigration(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    getPrice(_asset: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    getPricer(_asset: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
